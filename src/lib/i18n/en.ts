export const en = {
	...
	dashboard: {
		...
		schedulesAddHint: 'Add schedules from a customer\'s detail page.',
	...
	customer: {
		...
		importModeAppend: 'Append to existing customers',
		importModeReplace: 'Replace all existing customers',

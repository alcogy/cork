export const ja = {
	...
	dashboard: {
		...
		schedulesAddHint: '顧客の詳細ページから予定を追加できます。',
	...
	customer: {
		...
		addContact: '担当者を追加',
		editContact: '担当者を編集',
		deleteContact: '担当者を削除',
		deleteContactConfirm: 'この担当者を削除しますか？',
		department: '部署',
		position: '役職',
		remarks: '備考',
		scheduleTitle: 'タイトル',
		...
		deleteActivity: '行動履歴を削除',
		deleteActivityConfirm: 'この行動履歴を削除しますか？',
		exportCsv: 'CSV出力',
		importCsv: 'CSVインポート',
		importMode: 'インポートモード',
		importModeAppend: '既存データに追加',
		importModeReplace: '全件置換（既存データを削除してインポート）',
